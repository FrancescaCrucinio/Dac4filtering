...
# lines(1:Time.step, stpf_mean[1:Time.step], type = "l", col = "red")
# lines(1:Time.step, stpf_q1[1:Time.step], type = "l", col = "red", lty = "dashed")
# lines(1:Time.step, stpf_q3[1:Time.step], type = "l", col = "red", lty = "dashed")
lines(1:Time.step, bpf_mean[1:Time.step], type = "l", col = "green")
lines(1:Time.step, bpf_q1[1:Time.step], type = "l", col = "green", lty = "dashed")
lines(1:Time.step, bpf_q3[1:Time.step], type = "l", col = "green", lty = "dashed")
# lines(1:Time.step, dac_mean, type = "l", col = "blue")
# lines(1:Time.step, dac_q1, type = "l", col = "blue", lty = "dashed")
# lines(1:Time.step, dac_q3, type = "l", col = "blue", lty = "dashed")
