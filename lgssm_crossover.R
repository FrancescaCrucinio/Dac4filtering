...
tic()
res_dac <- dac_lgssm_lightweight_crossover(history[, , 1], y[t, ], tau, lambda, sigmaY, "adaptive")
runtime <- toc()
...
# dac (lightweight)
tic()
res_dac_light <- dac_lgssm_lightweight_crossover(history[, , 1], y[t, ], tau, lambda, sigmaY)
runtime <- toc()
