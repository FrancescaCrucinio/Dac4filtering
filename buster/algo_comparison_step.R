...
#write.csv(x=df_light, file=paste0("/storage/u1693998/results/results/light_lgssm_d", d, "N", Nparticles, "ID", ID))
...
write.csv(x=df_nsmc, file=paste0("/storage/u1693998/results/results/nsmc_lgssm_d", d, "N", Nparticles, "ID", ID))
