...
distances$runtime_mean <- c(rep(time_means$runtime[1], each = 50), rep(time_means$runtime[2], times = 50),
                            rep(time_means$runtime[3], times = 50), rep(time_means$runtime[4], times = 50))
