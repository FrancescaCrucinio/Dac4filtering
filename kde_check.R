library(ks)
node0 <- readRDS("test/lt_node0.rds")
node1 <-  readRDS("test/lt_node1.rds")
node2 <-  readRDS("test/lt_node2.rds")
node3 <-  readRDS("test/lt_node3.rds")
node4 <-  readRDS("test/lt_node4.rds")
node5 <-  readRDS("test/lt_node5.rds")
par(mfrow=c(4, 2))
for (i in 1:8) {
  kde0 <- kde(x = node0$x[, i], w = length(node0$W[, i])*node0$W[, i])
